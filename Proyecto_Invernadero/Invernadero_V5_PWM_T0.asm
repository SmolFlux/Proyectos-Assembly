...
__CONFIG  _XT_OSC & _WDT_OFF & _PWRTE_ON & _BODEN_OFF & _LVP_OFF ; Configuración de fusibles
	...
	CargaTMR0	EQU	d'61'			;Para conseguir la interrupción del timer 0 cada 50 ms.
	TMR0_1s		EQU	d'20'			;Cantidad de repeticiones para 1s
	TMR0_5s		EQU	d'100'			;Cantidad de repeticiones para 5s
	COM_MS		EQU d'60'			;Constante para comprobación de minutos y segundos
	COM_H		EQU d'1'			;Constante para comprobación de horas 
...
REFRESCADO
	...
	movlw d'20'						;una vez 50ms se repiten 20 veces, pasó 1 segundo
	movwf CONT
return
...
RELOJ	
	...
	limpieza_reloj						;Si ya pasaron 1 hora, se limpia el reloj y vuelve a contar desde 00:00:00
		...
		call  CONVERSION				;Cuando Z = 1, entonces pasó una hora y se hace la conversion ADC
