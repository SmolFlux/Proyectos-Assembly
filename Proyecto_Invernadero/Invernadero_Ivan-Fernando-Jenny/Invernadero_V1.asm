...
VISUALIZAR_DATOS
	...
	movf TEMPFH,W						;Ahora se visualiza en decimal.
...
CALCULO_TEMP
	...
	movlw d'100'
	movwf Arit_Multiplicador		;Multiplicamos TEMPL por 100
...
AJUSTE_TEMP				
	...
	;addwf TEMPFH					;					Error de calculo (?) - Verificar
	call REAJUSTE_TEMP				;Ajuste dependiente de la parte alta
return
