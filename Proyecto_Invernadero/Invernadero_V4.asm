dLIST      p=16F877A ; Define el microcontrolador
...
;-----------------------------------;Prendemos el LCD y limpiamos las variables 
	bsf STATUS,RP0     		;seleccione Banco 1
	movlw	b'00000111'		;Prescaler de 256 para el TMR0.						- CORREGIR PARA 10s 
	movwf	OPTION_REG		;Carga configuracion del TMR0
	movlw	b'10100000'    	;Habilita las iterrupciones globales y por TMR0
	movwf	INTCON			
	;-----------------------;Seccion Timer0
...
;-----------------------------------;Se configura ADCON1						- ERROR FATAL AL CICLAR, CHECAR AL SIMULAR
...
;-----------------------------------;Se configura el ADCON0
	call RETARDO_CARGA				
	call CARGA_TIMER				;Carga del timer0
...
CARGA_TIMER
									;Cargamos 10 segundos en el timer0 - checar diapositivas TMR0 
return
;-----------------------------------;Subrutina de carga del timer0
CALCULO_TEMP
